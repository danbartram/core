...
class Test_Config extends PHPUnit_Framework_TestCase {
	...
	function setUp() {
		$this->configFile = OC::$configDir.'testconfig.php';
		file_put_contents($this->configFile, self::TESTCONTENT);
		$this->config = new OC\Config(OC::$configDir, 'testconfig.php');
	}
	...
	public function testConfigMerge() {
		...
		$additionalConfigPath = OC::$configDir.'additionalConfig.testconfig.php';
